...
// Christmass lights with LPD8806-based RGB LED Modules in a strip (1 strip has 192 lights)
...
void loop() {
  ...
  // start with Color sparkles
  dither(strip.Color(0,127,127), 50);       // cyan, slow
  dither(strip.Color(0,0,0), 15);           // black, fast
  dither(strip.Color(127,0,127), 20);       // yellow, fast
 // dither(strip.Color(0,0,0), 10);           // black, fast

  // continue with rainbow
  rainbowCycle(10);  // make it go through the cycle not so fast
